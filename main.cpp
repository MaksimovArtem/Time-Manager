...
int main()
{
	...
	man.show_schedule();
	man.add_concrete_time(std::move(Task(3, 0, 5, 0, 1, 1, "some shit3")));
	man.show_schedule();
	man.add_concrete_time(std::move(Task(8, 0, 5, 3, 0, 1,"some shit4")));
	man.show_schedule();
	//man.add_concrete_time(std::move(Task(9, 0, 5, 0, 1, 1, "some shit5")));
	//man.show_schedule();
	//man.add_concrete_time(std::move(Task(9, 0, 6, 2, 1, 1, "some shit6")));
	//man.show_schedule();
